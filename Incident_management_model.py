...
######EDA##############
df=pd.read_excel('A:/Data Science/Project/Incidents_service.xlsx')
df.head()
df.shape
...
#clf=CatBoostClassifier(n_estimators=400)
#clf.fit(X_train,y_train,cat_features=categorical_features_indices)
...
pickle.dump(clf,open('Incident_management_model.pkl','wb'))
